...
export default {
    ...
    computed: {
        ...
        containerClasses() {
            return {
                'ms-tabs__container': true
            }
        },
        wrapperClasses() {
            return {
                'ms-tabs__wrapper': true,
                'ms-tabs__wrapper--scrollable': this.isScrollable(),
                'ms-tabs__wrapper--overflow': this.isOverflowing
            }
        },
        containerStyles() {
            return {
    ...
    methods: {
        ...
        newOffsetLeft(currentOffset, currentIndex) {
            ...
            for (let index = currentIndex - 1; index >= 0; index--) {
                if (!items[index].classList.contains('ms-tabs__slider')) {
